...
declare global {
  ...
  const useNodeInfoPanelStore: typeof import('./stores/node-info-panel')['useNodeInfoPanelStore']
...
declare global {
  ...
  // @ts-ignore
  export type { NodeColorPair, NodeColorInfo, RelationTypeInfo, RelationTreeItem, NodeShape } from './stores/graph'
  import('./stores/graph')
  // @ts-ignore
