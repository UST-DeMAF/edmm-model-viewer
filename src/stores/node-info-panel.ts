...
const DEFAULT_STATE: NodeInfoPanelState = {
...
export const useNodeInfoPanelStore = defineStore('node-info-panel', () => {
    // Persisted state using localStorage
    const state = useLocalStorage<NodeInfoPanelState>('node-info-panel-state', { ...DEFAULT_STATE })
...
if (import.meta.hot)
    import.meta.hot.accept(acceptHMRUpdate(useNodeInfoPanelStore as any, import.meta.hot))
